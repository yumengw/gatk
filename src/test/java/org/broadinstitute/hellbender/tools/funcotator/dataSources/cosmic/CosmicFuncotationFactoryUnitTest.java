...
public class CosmicFuncotationFactoryUnitTest extends GATKBaseTest {
    ...
    private static final ReferenceDataSource PIK3CA_REF_DATA_SOURCE = ReferenceDataSource.of( IOUtils.getPath(FuncotatorTestConstants.HG19_CHR3_REFERENCE_FILE_NAME) );
