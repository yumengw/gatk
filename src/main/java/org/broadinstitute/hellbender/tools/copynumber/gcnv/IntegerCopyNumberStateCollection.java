...
public class IntegerCopyNumberStateCollection {
    ...
    IntegerCopyNumberStateCollection(final List<String> copyNumberStatesColumns) {
        ...
        this.alleles = copyNumberStates.stream().map(AlleleMetadataProducer::toAllele).collect(Collectors.toList());
    }

    protected IntegerCopyNumberState get(final int index) {
    ...
    protected TableColumnCollection getTableColumnCollection() {
